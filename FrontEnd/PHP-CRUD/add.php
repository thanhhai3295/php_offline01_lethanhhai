...
?>
   	<div class="container">
		...
		<div class="card">
			...
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add User</strong></div>
					...
					<form method="post" action="">
						...
						<div class="form-group">
							...
							<select class="custom-select" name="chkStatus">
								<option value="1" <?php if(isset($_POST['chkStatus']) && $_POST['chkStatus'] == 1 ) echo 'selected' ?> >Active</option>
								<option value="0" <?php if(isset($_POST['chkStatus']) && $_POST['chkStatus'] == 0 ) echo 'selected' ?> >Inactive</option>
							</select>
						...
						<div class="form-group">
							...
							<div class="position-relative">
								<input type="text" name="ordering" class="form-control" placeholder="Enter Ordering" value="<?php if(isset($_POST['ordering'])) echo $_POST['ordering']; ?>">
